...
all_files = [y for y in os.listdir(img_path_train) if (('.png' in y) & (~y.startswith('unknown_')))]
all_files_unk = [y for y in os.listdir(img_path_train) if (('.png' in y)& (y.startswith('unknown_')))]
